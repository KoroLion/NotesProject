...
<body class="bg-light">
	<div class="container">
		...
		<?php
			...
			if (isset($_POST['edit_id']) && isset($_POST['edit_title']) && isset($_POST['edit_content'])) {
				$id = $_POST['edit_id'];
				...
				echo '<div class="alert alert-success">Записка успешно обновлена!</div>';
			}
		?>

		<div class="card">
			<?php
				//for SQL injection demo $query = $db->query('SELECT title, content FROM notes WHERE id = '.$_GET['id'].';'); //shownote.php?id=1; DROP TABLE notes;
